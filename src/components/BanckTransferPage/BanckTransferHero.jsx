                ...
                >
                  <div className="p-lg-4 p-3 w-100">
                    <div className="rounded-3 pt-0 pt-lg-3 p-3">
                      ...
                      <div
                        className="d-flex ps-2 pe-1 align-items-center border border-1 mt-1 rounded-2 overflow-hidden w-100"
                        style={{ maxWidth: "100%" }}
                      >
                        <Image src={ssIcon} alt="Logo" width={30} height={30} />
                        <div
